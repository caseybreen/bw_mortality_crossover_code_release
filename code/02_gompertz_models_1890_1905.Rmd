...
Summary: Re-calculate the BW-crossover using Gompertz models
...
```{r}
dmf_black <- dmf_restrict %>% filter(race == "Black Men")
dmf_white <- dmf_restrict %>% filter(race == "White Men")
```
...
ggsave(plot = crossover_gompertz_combined, filename = here("figures", "fig6_bw_crossover_gompertz_combined.png"), width = 12, height = 5, bg = "white")
```
