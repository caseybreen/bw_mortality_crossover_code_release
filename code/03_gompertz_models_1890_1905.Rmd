...
ggsave(plot = mortality_crossover_1890_1905, filename = here("figures_brief", "bw_crossover_gompertz_1890_1905.png"), width = 7, height = 5, bg = "white")
```
...
ggsave(plot = crossover_gompertz_combined, filename = here("figures_brief", "bw_crossover_gompertz_combined.png"), width = 12, height = 5, bg = "white")
```
