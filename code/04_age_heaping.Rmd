...
heaping_birth_year_plot <- tabulated_byear %>% 
  ...
  labs(x = "Birth Year", y = "Count of Deaths") +
  theme(
...
## Plot death year 
ggsave(plot = heaping_combined_plot, filename = here("figures", "appendix_age_heaping_plot.png"), width = 8, height = 8, bg = "white")
```
...
ggsave(plot = age_heaping_age_plot, filename = here("figures", "appendix_age_heaping_death_age.png"), width = 6, height = 4, bg = "white")
```
