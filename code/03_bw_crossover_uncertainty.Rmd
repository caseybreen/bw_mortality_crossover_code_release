...
ggsave(plot = crossover_census_weights_checks, filename = here("figures", "crossover_census_weights_1940census_weights.png"), width = 12, height = 8, bg = "white")
```
...
ggsave(plot = fig3_robustness, filename = here("figures", "fig4_bw_crossover_1890_1905_robustness.png"), width = 12, height = 14, bg = "white")
```
...
crossover_by_cohort <- ggplot(df_wide, aes(x = death_age, y = diff_bw, group = byear)) +
  ...
  ggsave(plot = crossover_by_cohort, filename = here("figures", "fig2_bw_crossover_1890_1905_by_cohort.png"), width = 10, height = 10, bg = "white")
```
